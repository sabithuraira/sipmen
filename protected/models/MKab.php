 ...
 */
class MKab extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('idProv, idKab, nmKab', 'required'),
			array('idProv, idKab', 'length', 'max'=>2),
			array('nmKab', 'length', 'max'=>25),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idProv, idKab, nmKab', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('nmKab',$this->nmKab,true);
	 ...
	 * @return MKab the static model class
	 */
